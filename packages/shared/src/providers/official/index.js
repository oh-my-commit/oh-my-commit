...
var require_url_state_machine = __commonJS({
  "../../node_modules/.pnpm/whatwg-url@5.0.0/node_modules/whatwg-url/lib/url-state-machine.js"(exports2, module2) {
    ...
    URLStateMachine.prototype["parse scheme start"] = /* @__PURE__ */ __name(function parseSchemeStart(c2, cStr) {
      if (isASCIIAlpha(c2)) {
    ...
    URLStateMachine.prototype["parse scheme"] = /* @__PURE__ */ __name(function parseScheme(c2, cStr) {
    ...
    URLStateMachine.prototype["parse no scheme"] = /* @__PURE__ */ __name(function parseNoScheme(c2) {
    ...
    URLStateMachine.prototype["parse special relative or authority"] = /* @__PURE__ */ __name(function parseSpecialRelativeOrAuthority(c2) {
    ...
    URLStateMachine.prototype["parse path or authority"] = /* @__PURE__ */ __name(function parsePathOrAuthority(c2) {
      if (c2 === 47) {
    ...
    URLStateMachine.prototype["parse relative"] = /* @__PURE__ */ __name(function parseRelative(c2) {
      this.url.scheme = this.base.scheme;
      if (isNaN(c2)) {
    ...
    URLStateMachine.prototype["parse relative slash"] = /* @__PURE__ */ __name(function parseRelativeSlash(c2) {
    ...
    URLStateMachine.prototype["parse special authority slashes"] = /* @__PURE__ */ __name(function parseSpecialAuthoritySlashes(c2) {
      if (c2 === 47 && this.input[this.pointer + 1] === 47) {
        this.state = "special authority ignore slashes";
        ++this.pointer;
      } else {
    ...
    URLStateMachine.prototype["parse special authority ignore slashes"] = /* @__PURE__ */ __name(function parseSpecialAuthorityIgnoreSlashes(c2) {
      if (c2 !== 47 && c2 !== 92) {
        this.state = "authority";
        --this.pointer;
      } else {
    ...
    URLStateMachine.prototype["parse authority"] = /* @__PURE__ */ __name(function parseAuthority(c2, cStr) {
      if (c2 === 64) {
        this.parseError = true;
        if (this.atFlag) {
    ...
    URLStateMachine.prototype["parse hostname"] = URLStateMachine.prototype["parse host"] = /* @__PURE__ */ __name(function parseHostName(c2, cStr) {
    ...
    URLStateMachine.prototype["parse port"] = /* @__PURE__ */ __name(function parsePort(c2, cStr) {
      if (isASCIIDigit(c2)) {
        this.buffer += cStr;
    ...
    URLStateMachine.prototype["parse file"] = /* @__PURE__ */ __name(function parseFile(c2) {
    ...
    URLStateMachine.prototype["parse file slash"] = /* @__PURE__ */ __name(function parseFileSlash(c2) {
      if (c2 === 47 || c2 === 92) {
        if (c2 === 92) {
          this.parseError = true;
        }
    ...
    URLStateMachine.prototype["parse file host"] = /* @__PURE__ */ __name(function parseFileHost(c2, cStr) {
    ...
    URLStateMachine.prototype["parse path start"] = /* @__PURE__ */ __name(function parsePathStart(c2) {
    ...
    URLStateMachine.prototype["parse path"] = /* @__PURE__ */ __name(function parsePath(c2) {
    ...
    URLStateMachine.prototype["parse cannot-be-a-base-URL path"] = /* @__PURE__ */ __name(function parseCannotBeABaseURLPath(c2) {
      if (c2 === 63) {
        this.url.query = "";
        this.state = "query";
      } else if (c2 === 35) {
    ...
    URLStateMachine.prototype["parse query"] = /* @__PURE__ */ __name(function parseQuery(c2, cStr) {
    ...
    URLStateMachine.prototype["parse fragment"] = /* @__PURE__ */ __name(function parseFragment(c2) {
      if (isNaN(c2)) {
      } else if (c2 === 0) {
        this.parseError = true;
      } else {
...
var init_ponyfill = __esm({
  "../../node_modules/.pnpm/web-streams-polyfill@4.0.0-beta.3/node_modules/web-streams-polyfill/dist/ponyfill.mjs"() {
    ...
    er = /* @__PURE__ */ __name((e2) => e2.byteLength, "er");
    n(er, "size");
      ...
      constructor(e2 = {}, t2 = {}, r2 = {}) {
        ...
        !function(e3, t3, r3, o3, n3, a3) {
          ...
          e3._writableState = "writable", e3._writableStoredError = void 0, e3._writableHasInFlightOperation = false, e3._writableStarted = false, e3._writable = function(e4, t4, r4, o4, n4, a4, i4) {
            ...
            return new ReadableStream2({ start: /* @__PURE__ */ __name((r5) => (e4._readableController = r5, t4().catch((t5) => {
              Sr(e4, t5);
...
var require_agent = __commonJS({
  "../../node_modules/.pnpm/agentkeepalive@4.5.0/node_modules/agentkeepalive/lib/agent.js"(exports2, module2) {
    ...
    var { INIT_SOCKET, CURRENT_ID, CREATE_ID, SOCKET_CREATED_TIME, SOCKET_NAME, SOCKET_REQUEST_COUNT, SOCKET_REQUEST_FINISHED_COUNT } = require_constants();
    ...
    var Agent = class Agent extends OriginalAgent {
      static {
        __name(this, "Agent");
      }
      constructor(options) {
      ...
      createConnection(options, oncreate) {
        let called = false;
        const onNewCreate = /* @__PURE__ */ __name((err2, socket) => {
          if (called) return;
          called = true;
          if (err2) {
...
var require_https_agent = __commonJS({
  "../../node_modules/.pnpm/agentkeepalive@4.5.0/node_modules/agentkeepalive/lib/https_agent.js"(exports2, module2) {
    ...
    var HttpsAgent = class HttpsAgent extends HttpAgent {
      static {
...
var require_abort_controller = __commonJS({
  "../../node_modules/.pnpm/abort-controller@3.0.0/node_modules/abort-controller/dist/abort-controller.js"(exports2, module2) {
    ...
    var AbortSignal = class AbortSignal extends eventTargetShim.EventTarget {
      static {
    ...
    var AbortController2 = class AbortController {
      static {
...
var init_fileFromPath = __esm({
  "../../node_modules/.pnpm/formdata-node@4.4.1/node_modules/formdata-node/lib/esm/fileFromPath.js"() {
    ...
    FileFromPath = class FileFromPath2 {
      static {
...
var require_helpers = __commonJS({
  "../../node_modules/.pnpm/agent-base@7.1.3/node_modules/agent-base/dist/helpers.js"(exports2) {
    ...
    function req(url, opts = {}) {
      ...
      const req1 = (href.startsWith("https:") ? https2 : http2).request(url, opts);
...
var require_dist = __commonJS({
  "../../node_modules/.pnpm/agent-base@7.1.3/node_modules/agent-base/dist/index.js"(exports2) {
    ...
    var Agent = class Agent extends http2.Agent {
      static {
        __name(this, "Agent");
      }
      constructor(opts) {
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/version.mjs
var VERSION = "0.32.1";

// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/_shims/registry.mjs
var auto = false;
var kind = void 0;
var fetch2 = void 0;
var Request = void 0;
...
var FormData2 = class {
  ...
  *values() {
  ...
  [(_FormData_setEntry = /* @__PURE__ */ __name(function _FormData_setEntry2({ name, rawValue, append, fileName, argsLength }) {
    ...
    let value;
    if (isFile(rawValue)) {
      value = fileName === void 0 ? rawValue : new File2([
        rawValue
      ], fileName, {
        type: rawValue.type,
    ...
    if (!values) {
      return void __classPrivateFieldGet3(this, _FormData_entries, "f").set(name, [
        value
      ]);
    }
    if (!append) {
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/_shims/node-runtime.mjs
...
var FormDataEncoder = class {
  ...
  constructor(form, boundaryOrOptions, options) {
    ...
    __classPrivateFieldSet3(this, _FormDataEncoder_options, {
      ...defaultOptions,
      ...options
    }, "f");
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/_shims/MultipartBody.mjs
...
function getRuntime() {
  ...
  return {
    ...
    isFsReadStream: /* @__PURE__ */ __name((value) => value instanceof import_node_fs.ReadStream, "isFsReadStream")
  };
}
__name(getRuntime, "getRuntime");

// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/_shims/index.mjs
if (!kind) setShims(getRuntime(), { auto: true });

// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/error.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/internal/decoders/line.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/streaming.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/uploads.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/core.mjs
...
var castToError = /* @__PURE__ */ __name((err2) => {
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/pagination.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resource.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/internal/decoders/jsonl.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/beta/messages/batches.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/beta/messages/messages.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/_vendor/partial-json-parser/parser.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/lib/PromptCachingBetaMessageStream.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/messages.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/beta/prompt-caching/prompt-caching.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/beta/beta.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/completions.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/lib/MessageStream.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/messages.mjs
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/index.mjs
var _a;
...
// ../shared/src/common/app.ts
var APP_NAME = "Oh My Commit";
var APP_ID_DASH = "oh-my-commit";
var APP_ID_CAMEL = "ohMyCommit";
var COMMAND_OPEN_PREFERENCE = `${APP_ID_CAMEL}.openPreference`;
var COMMAND_QUICK_COMMIT = `${APP_ID_CAMEL}.quickCommit`;
var COMMAND_SELECT_MODEL = `${APP_ID_CAMEL}.selectModel`;
var SETTING_MODEL_ID = `${APP_ID_CAMEL}.model.id`;
...
var ServiceNotFoundError = (
  ...
  function(_super) {
    ...
    __name(ServiceNotFoundError2, "ServiceNotFoundError");
...
var CannotInstantiateValueError = (
  ...
  function(_super) {
    ...
    __name(CannotInstantiateValueError2, "CannotInstantiateValueError");
...
var ContainerInstance = (
  ...
  function() {
    ...
    __name(ContainerInstance2, "ContainerInstance");
...
// ../../node_modules/.pnpm/typedi@0.10.0/node_modules/typedi/esm5/error/cannot-inject-value.error.js
...
var CannotInjectValueError = (
  /** @class */
  function(_super) {
    __extends3(CannotInjectValueError2, _super);
    function CannotInjectValueError2(target, propertyName) {
      var _this = _super.call(this) || this;
      _this.target = target;
    ...
    __name(CannotInjectValueError2, "CannotInjectValueError");
    Object.defineProperty(CannotInjectValueError2.prototype, "message", {
      get: /* @__PURE__ */ __name(function() {
    ...
    return CannotInjectValueError2;
  }(Error)
);

// ../../node_modules/.pnpm/typedi@0.10.0/node_modules/typedi/esm5/utils/resolve-to-type-wrapper.util.js
function resolveToTypeWrapper(typeOrIdentifier, target, propertyName, index) {
  ...
  if (typeOrIdentifier && typeof typeOrIdentifier === "string" || typeOrIdentifier instanceof Token) {
    typeWrapper = {
      ...
      lazyType: /* @__PURE__ */ __name(function() {
...
// ../../node_modules/.pnpm/typedi@0.10.0/node_modules/typedi/esm5/decorators/inject.decorator.js
function Inject(typeOrIdentifier) {
  return function(target, propertyName, index) {
    ...
    Container.registerHandler({
      ...
      propertyName,
      index,
      value: /* @__PURE__ */ __name(function(containerInstance) {
...
// ../shared/src/common/core.ts
var TOKENS = {
  Config: new Token("Config"),
  Logger: new Token("Logger"),
  ProviderRegistry: new Token("ProviderManager"),
  CommitManager: new Token("CommitManager"),
  UIProvider: new Token("UIProvider")
};
...
function __classPrivateFieldGet9(receiver, state, kind2, f2) {
  if (kind2 === "a" && !f2) throw new TypeError("Private accessor was defined without a getter");
  if (typeof state === "function" ? receiver !== state || !f2 : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return kind2 === "m" ? f2 : kind2 === "a" ? f2.call(receiver) : f2 ? f2.value : state.get(receiver);
}
__name(__classPrivateFieldGet9, "__classPrivateFieldGet");
function __classPrivateFieldSet8(receiver, state, value, kind2, f2) {
  if (kind2 === "m") throw new TypeError("Private method is not writable");
  if (kind2 === "a" && !f2) throw new TypeError("Private accessor was defined without a setter");
  if (typeof state === "function" ? receiver !== state || !f2 : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return kind2 === "a" ? f2.call(receiver, value) : f2 ? f2.value = value : state.set(receiver, value), value;
}
__name(__classPrivateFieldSet8, "__classPrivateFieldSet");
var errorUtil;
(function(errorUtil2) {
...
var ZodEnum = class _ZodEnum extends ZodType {
  ...
  _parse(input) {
    ...
    if (!__classPrivateFieldGet9(this, _ZodEnum_cache, "f")) {
      __classPrivateFieldSet8(this, _ZodEnum_cache, new Set(this._def.values), "f");
    }
    if (!__classPrivateFieldGet9(this, _ZodEnum_cache, "f").has(input.data)) {
      const ctx = this._getOrReturnCtx(input);
      const expectedValues = this._def.values;
      addIssueToContext(ctx, {
        received: ctx.data,
...
var ZodNativeEnum = class extends ZodType {
  ...
  _parse(input) {
    ...
    if (!__classPrivateFieldGet9(this, _ZodNativeEnum_cache, "f")) {
      __classPrivateFieldSet8(this, _ZodNativeEnum_cache, new Set(util.getValidEnumValues(this._def.values)), "f");
    }
    if (!__classPrivateFieldGet9(this, _ZodNativeEnum_cache, "f").has(input.data)) {
      const expectedValues = util.objectValues(nativeEnumValues);
      addIssueToContext(ctx, {
        received: ctx.data,
        code: ZodIssueCode.invalid_enum_value,
...
function getCallerInfo() {
  ...
  const relativePath = (srcIndex !== -1 ? filePath.substring(srcIndex + 5) : filePath.split("/").pop() || "unknown").replace(".js", ".ts");
...
var BaseLogger = class {
  ...
  constructor(name) {
    this.name = name;
    this.minLevel = DEFAULT_LOG_LEVEL;
    this.name = name;
  }
  setName(name) {
    this.name = name;
...
var ConsoleLogger = class extends BaseLogger {
  ...
  log(level, ...args) {
    ...
    console.log(source_default.green(`${timestamp} ${levelStr}`) + ` | [${loggerName}] ` + source_default.blue(`[${caller}] `) + formattedMsg);
  }
};
...
// ../shared/src/common/generate-commit.ts
...
var CommitManager = class _CommitManager {
  static {
    __name(this, "CommitManager");
  }
  providers = [];
  status = {
  ...
  */
  async initProviders() {
    if (!_CommitManager.initPromise) {
      _CommitManager.initPromise = this.doInitProviders();
    }
    try {
      await _CommitManager.initPromise;
    } catch (error) {
      _CommitManager.initPromise = null;
      throw error;
    }
  }
  async doInitProviders() {
    ...
    try {
      ...
      this.logger.error(`Failed to load providers: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  async generateCommit(diff, options) {
    await this.initProviders();
    const modelId = this.config.get(SETTING_MODEL_ID) ?? this.providers[0]?.models[0]?.id;
    if (!modelId) {
      throw new Error("No model available");
    }
    const provider = this.providers.find((p2) => p2.models.some((model) => model.id === modelId));
    if (!provider) {
...
_ts_decorate2([
  ...
  _ts_metadata2("design:type", typeof IConfig === "undefined" ? Object : IConfig)
], CommitManager.prototype, "config", void 0);
_ts_decorate2([
  Inject(TOKENS.Logger),
  _ts_metadata2("design:type", typeof ILogger === "undefined" ? Object : ILogger)
], CommitManager.prototype, "logger", void 0);
_ts_decorate2([
  Inject(TOKENS.ProviderRegistry),
  _ts_metadata2("design:type", typeof IProviderManager === "undefined" ? Object : IProviderManager)
], CommitManager.prototype, "providersManager", void 0);
CommitManager = _ts_decorate2([
  Service()
], CommitManager);
var ModelSchema = z2.object({
  /** 供应商唯一标识符，用于区分不同的供应商 */
  providerId: z2.string().describe("\u4F9B\u5E94\u5546\u552F\u4E00\u6807\u8BC6\u7B26\uFF0C\u7528\u4E8E\u533A\u5206\u4E0D\u540C\u7684\u4F9B\u5E94\u5546"),
  /** 模型唯一标识符，在同一供应商下必须唯一 */
  id: z2.string().describe("\u6A21\u578B\u552F\u4E00\u6807\u8BC6\u7B26\uFF0C\u5728\u540C\u4E00\u4F9B\u5E94\u5546\u4E0B\u5FC5\u987B\u552F\u4E00"),
  /** 模型显示名称，用于在 UI 中展示 */
  name: z2.string().describe("\u6A21\u578B\u663E\u793A\u540D\u79F0\uFF0C\u7528\u4E8E\u5728 UI \u4E2D\u5C55\u793A"),
  /** 模型详细描述，说明模型的特点和适用场景 */
  description: z2.string().describe("\u6A21\u578B\u8BE6\u7EC6\u63CF\u8FF0\uFF0C\u8BF4\u660E\u6A21\u578B\u7684\u7279\u70B9\u548C\u9002\u7528\u573A\u666F"),
  /** 模型性能指标，用于评估模型的各项能力 */
  metrics: z2.object({
    /** 准确度评分 (0-1)，越高表示生成的提交信息越准确 */
    accuracy: z2.number().min(0).max(1).describe("\u51C6\u786E\u5EA6\u8BC4\u5206 (0-1)\uFF0C\u8D8A\u9AD8\u8868\u793A\u751F\u6210\u7684\u63D0\u4EA4\u4FE1\u606F\u8D8A\u51C6\u786E"),
    /** 速度评分 (0-1)，越高表示生成速度越快 */
    speed: z2.number().min(0).max(1).describe("\u901F\u5EA6\u8BC4\u5206 (0-1)\uFF0C\u8D8A\u9AD8\u8868\u793A\u751F\u6210\u901F\u5EA6\u8D8A\u5FEB"),
    /** 成本评分 (0-1)，越高表示使用成本越高 */
    cost: z2.number().min(0).max(1).describe("\u6210\u672C\u8BC4\u5206 (0-1)\uFF0C\u8D8A\u9AD8\u8868\u793A\u4F7F\u7528\u6210\u672C\u8D8A\u9AD8")
  }).describe("\u6A21\u578B\u6027\u80FD\u6307\u6807\uFF0C\u7528\u4E8E\u8BC4\u4F30\u6A21\u578B\u7684\u5404\u9879\u80FD\u529B").optional()
});
var GenerateCommitInputSchema = z2.object({
  /** 选择的模型信息 */
  model: z2.string().describe("\u9009\u62E9\u7684\u6A21\u578B"),
  /** Git diff 信息，包含文件变更的详细内容 */
  diff: z2.any().describe("Git diff \u4FE1\u606F\uFF0C\u5305\u542B\u6587\u4EF6\u53D8\u66F4\u7684\u8BE6\u7EC6\u5185\u5BB9"),
  /** 生成选项配置 */
  options: z2.object({
    /** 期望生成的提交信息语言，例如 'en' 或 'zh' */
    lang: z2.string().optional().describe("\u671F\u671B\u751F\u6210\u7684\u63D0\u4EA4\u4FE1\u606F\u8BED\u8A00\uFF0C\u4F8B\u5982 'en' \u6216 'zh'")
  }).describe("\u751F\u6210\u9009\u9879\u914D\u7F6E").optional()
});
var ProviderSchema = z2.object({
  /** 供应商唯一标识符 */
  id: z2.string().describe("\u4F9B\u5E94\u5546\u552F\u4E00\u6807\u8BC6\u7B26"),
  /** 供应商显示名称，用于在 UI 中展示 */
  displayName: z2.string().describe("\u4F9B\u5E94\u5546\u663E\u793A\u540D\u79F0\uFF0C\u7528\u4E8E\u5728 UI \u4E2D\u5C55\u793A"),
  /** 供应商详细描述，说明支持的功能和特点 */
  description: z2.string().describe("\u4F9B\u5E94\u5546\u8BE6\u7EC6\u63CF\u8FF0\uFF0C\u8BF4\u660E\u652F\u6301\u7684\u529F\u80FD\u548C\u7279\u70B9"),
  /** 供应商提供的模型列表 */
  models: z2.array(ModelSchema).describe("\u4F9B\u5E94\u5546\u63D0\u4F9B\u7684\u6A21\u578B\u5217\u8868"),
  /** 生成提交信息的核心方法 */
  generateCommit: z2.function().args(GenerateCommitInputSchema).returns(z2.any()).describe("\u751F\u6210\u63D0\u4EA4\u4FE1\u606F\u7684\u6838\u5FC3\u65B9\u6CD5")
});
var BaseGenerateCommitProvider = class {
  static {
    __name(this, "BaseGenerateCommitProvider");
  }
  logger;
  /**x
  ...
  */
  toJSON() {
    return {
      ...
      models: this.models.map((m2) => m2.id)
    };
  }
};
_ts_decorate2([
  Inject(TOKENS.Logger),
  _ts_metadata2("design:type", typeof BaseLogger === "undefined" ? Object : BaseLogger)
], BaseGenerateCommitProvider.prototype, "logger", void 0);
BaseGenerateCommitProvider = _ts_decorate2([
  Service()
], BaseGenerateCommitProvider);
var GenerateCommitError = class extends Error {
  static {
    __name(this, "GenerateCommitError");
  }
  code;
...
function baseIsNative(value) {
  ...
  var pattern = isFunction_default2(value) ? reIsNative : reIsHostCtor;
...
var isPlainObject_default3 = isPlainObject3;
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    ...
    } else if (isPlainObject_default3(srcValue) || isArguments_default(srcValue)) {
      newValue = objValue;
      if (isArguments_default(objValue)) {
        newValue = toPlainObject_default(objValue);
      } else if (!isObject_default(objValue) || isFunction_default2(objValue)) {
...
var createNeverThrowError = /* @__PURE__ */ __name((message, result, config = defaultErrorConfig) => {
...
var ResultAsync = class ResultAsync2 {
  static {
    __name(this, "ResultAsync");
  }
  constructor(res) {
    this._promise = res;
  }
  ...
  static fromThrowable(fn, errorFn) {
    return (...args) => {
      return new ResultAsync2((() => __awaiter(this, void 0, void 0, function* () {
        try {
  ...
  map(f2) {
    return new ResultAsync2(this._promise.then((res) => __awaiter(this, void 0, void 0, function* () {
      if (res.isErr()) {
   ...
   */
  safeUnwrap() {
    return __asyncGenerator(this, arguments, /* @__PURE__ */ __name(function* safeUnwrap_1() {
  ...
  [Symbol.asyncIterator]() {
    return __asyncGenerator(this, arguments, /* @__PURE__ */ __name(function* _a2() {
...
var errAsync = /* @__PURE__ */ __name((err2) => new ResultAsync(Promise.resolve(new Err(err2))), "errAsync");
var fromPromise = ResultAsync.fromPromise;
var fromSafePromise = ResultAsync.fromSafePromise;
var fromAsyncThrowable = ResultAsync.fromThrowable;
var combineResultList = /* @__PURE__ */ __name((resultList) => {
  let acc = ok([]);
...
var combineResultAsyncList = /* @__PURE__ */ __name((asyncResultList) => ResultAsync.fromSafePromise(Promise.all(asyncResultList)).andThen(combineResultList), "combineResultAsyncList");
var combineResultListWithAllErrors = /* @__PURE__ */ __name((resultList) => {
  let acc = ok([]);
  for (const result of resultList) {
...
var combineResultAsyncListWithAllErrors = /* @__PURE__ */ __name((asyncResultList) => ResultAsync.fromSafePromise(Promise.all(asyncResultList)).andThen(combineResultListWithAllErrors), "combineResultAsyncListWithAllErrors");
var Result;
(function(Result2) {
  ...
  __name(fromThrowable2, "fromThrowable");
  ...
  __name(combineWithAllErrors, "combineWithAllErrors");
...
// src/index.ts
var loadPrompt = /* @__PURE__ */ __name((_lang, diff) => {
  return `\u4F5C\u4E3A\u4E00\u4E2A\u7ECF\u9A8C\u4E30\u5BCC\u7684\u5F00\u53D1\u8005\uFF0C\u8BF7\u5206\u6790\u4EE5\u4E0B\u4EE3\u7801\u53D8\u66F4\u5E76\u751F\u6210\u63D0\u4EA4\u4FE1\u606F\uFF1A
${diff}`;
}, "loadPrompt");
var StandardModelId = `${APP_ID_DASH}.standard`;
var StandardModel = class StandardModel2 {
  static {
    __name(this, "StandardModel");
  }
  id = StandardModelId;
...
var OfficialProvider = class extends BaseGenerateCommitProvider {
  static {
    __name(this, "OfficialProvider");
  }
  id = APP_ID_CAMEL;
  ...
  anthropic = null;
  constructor(_apiKey, proxyUrl) {
    super();
    const apiKey = _apiKey || process.env.ANTHROPIC_API_KEY;
    const proxy = proxyUrl || process.env.HTTP_PROXY || process.env.HTTPS_PROXY || process.env.ALL_PROXY;
    const config = {
      apiKey
    };
    if (proxy) config["httpAgent"] = new import_https_proxy_agent.HttpsProxyAgent(proxy);
    if (apiKey) this.anthropic = new Anthropic(config);
  }
  generateCommit(input) {
    this.logger.info("Generating commit message using OMC Provider...");
    return (
      // 1. call api
      ResultAsync.fromPromise(this.callApi(input), (error) => new GenerateCommitError(-10086, `failed to call api, reason: ${formatError(error)}`)).andThen((response) => ResultAsync.fromPromise(this.handleApiResult(response), (error) => new GenerateCommitError(-10087, `failed to handle api result, reason: ${formatError(error)}`))).map((result) => {
        merge_default(result.meta, {
      ...
      tools: [
        {
          ...
          input_schema: {
            ...
            properties: {
              title: {
                type: "string",
                description: "Commit title following conventional commits format: <type>[optional scope]: <description>"
              },
              body: {
                type: "string",
  ...
  async handleApiResult(response) {
...
var index_default = OfficialProvider;
