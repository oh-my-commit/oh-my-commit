...
export const handleKeyDown = (e, text, selectionStart, selectionEnd, onChange, setSelectionRange) => {
    ...
    if (e.key === "Tab") {
        ...
        let startLineIndex = text.slice(0, selectionStart).split("\n").length - 1;
        ...
        setTimeout(() => {
            if (startLineIndex === endLineIndex) {
                ...
                console.log("Setting single line cursor position:", {
                    ...
                    oldEnd: selectionEnd,
                    newStart: newPos,
                    newEnd: selectionStart === selectionEnd
                        ? newPos
                        : newPos + (selectionEnd - selectionStart),
                });
                setSelectionRange(newPos, selectionStart === selectionEnd
                    ? newPos
                    : newPos + (selectionEnd - selectionStart));
            }
            else {
...
//# sourceMappingURL=handle-input.js.map