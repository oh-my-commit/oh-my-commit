...
// ../../node_modules/.pnpm/tsup@8.3.5_jiti@1.21.7_postcss@8.4.49_typescript@5.3.3_yaml@2.6.1/node_modules/tsup/assets/cjs_shims.js
  ...
  "../../node_modules/.pnpm/formdata-node@4.4.1/node_modules/formdata-node/lib/esm/fileFromPath.js"() {
    ...
    FileFromPath = class _FileFromPath {
      constructor(input) {
        ...
        this.name = path.basename(__classPrivateFieldGet5(this, _FileFromPath_path, "f"));
      ...
      async *stream() {
        const { mtimeMs } = await fs.promises.stat(__classPrivateFieldGet5(this, _FileFromPath_path, "f"));
        if (mtimeMs > this.lastModified) {
          throw new import_node_domexception.default(MESSAGE, "NotReadableError");
        }
        if (this.size) {
          yield* fs.createReadStream(__classPrivateFieldGet5(this, _FileFromPath_path, "f"), {
...
var URL2 = Url__default.default.URL || import_whatwg_url.default.URL;
...
var URL$1 = Url__default.default.URL || import_whatwg_url.default.URL;
...
var FormDataEncoder = class {
  constructor(form, boundaryOrOptions, options) {
    ...
    __classPrivateFieldSet3(this, _FormDataEncoder_form, form);
    __classPrivateFieldSet3(this, _FormDataEncoder_options, { ...defaultOptions, ...options });
    __classPrivateFieldSet3(this, _FormDataEncoder_CRLF_BYTES, __classPrivateFieldGet4(this, _FormDataEncoder_encoder, "f").encode(__classPrivateFieldGet4(this, _FormDataEncoder_CRLF, "f")));
    __classPrivateFieldSet3(this, _FormDataEncoder_CRLF_BYTES_LENGTH, __classPrivateFieldGet4(this, _FormDataEncoder_CRLF_BYTES, "f").byteLength);
    this.boundary = `form-data-boundary-${boundary}`;
    this.contentType = `multipart/form-data; boundary=${this.boundary}`;
    __classPrivateFieldSet3(this, _FormDataEncoder_footer, __classPrivateFieldGet4(this, _FormDataEncoder_encoder, "f").encode(`${__classPrivateFieldGet4(this, _FormDataEncoder_DASHES, "f")}${this.boundary}${__classPrivateFieldGet4(this, _FormDataEncoder_DASHES, "f")}${__classPrivateFieldGet4(this, _FormDataEncoder_CRLF, "f").repeat(2)}`));
...
async function getMultipartRequestOptions2(form, opts) {
  ...
  const readable = Stream.Readable.from(encoder);
...
function getRuntime() {
  ...
  return {
    ...
    isFsReadStream: (value) => value instanceof fs.ReadStream
  };
}
...
var AbstractPage = class {
  constructor(client, response, body, options) {
    ...
    __classPrivateFieldSet5(this, _AbstractPage_client, client);
...
// ../../node_modules/.pnpm/@anthropic-ai+sdk@0.32.1/node_modules/@anthropic-ai/sdk/resources/index.mjs
init_cjs_shims();
...
var PromptCachingBetaMessageStream = class _PromptCachingBetaMessageStream {
  constructor() {
    ...
    _PromptCachingBetaMessageStream_handleError.set(this, (error) => {
      __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_errored, true);
      if (error instanceof Error && error.name === "AbortError") {
        error = new APIUserAbortError();
      }
      if (error instanceof APIUserAbortError) {
        __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_aborted, true);
  ...
  emitted(event) {
    return new Promise((resolve, reject) => {
      __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_catchingPromiseCreated, true);
      if (event !== "error")
  ...
  _emit(event, ...args) {
    if (__classPrivateFieldGet7(this, _PromptCachingBetaMessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_ended, true);
  ...
  [(_PromptCachingBetaMessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_listeners = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_ended = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_errored = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_aborted = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_handleError = /* @__PURE__ */ new WeakMap(), _PromptCachingBetaMessageStream_instances = /* @__PURE__ */ new WeakSet(), _PromptCachingBetaMessageStream_getFinalMessage = function _PromptCachingBetaMessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, void 0);
    ...
    switch (event.type) {
      ...
      case "message_start": {
        __classPrivateFieldSet6(this, _PromptCachingBetaMessageStream_currentMessageSnapshot, messageSnapshot);
        break;
      }
    }
...
var MessageStream = class _MessageStream {
  constructor() {
    ...
    _MessageStream_handleError.set(this, (error) => {
      __classPrivateFieldSet7(this, _MessageStream_errored, true);
      if (error instanceof Error && error.name === "AbortError") {
        error = new APIUserAbortError();
      }
      if (error instanceof APIUserAbortError) {
        __classPrivateFieldSet7(this, _MessageStream_aborted, true);
        return this._emit("abort", error);
      }
      if (error instanceof AnthropicError) {
        return this._emit("error", error);
  ...
  emitted(event) {
    return new Promise((resolve, reject) => {
      __classPrivateFieldSet7(this, _MessageStream_catchingPromiseCreated, true);
      if (event !== "error")
        this.once("error", reject);
      this.once(event, resolve);
    });
  ...
  _emit(event, ...args) {
    if (__classPrivateFieldGet8(this, _MessageStream_ended, "f"))
      return;
    if (event === "end") {
      __classPrivateFieldSet7(this, _MessageStream_ended, true);
  ...
  [(_MessageStream_currentMessageSnapshot = /* @__PURE__ */ new WeakMap(), _MessageStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_endPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _MessageStream_listeners = /* @__PURE__ */ new WeakMap(), _MessageStream_ended = /* @__PURE__ */ new WeakMap(), _MessageStream_errored = /* @__PURE__ */ new WeakMap(), _MessageStream_aborted = /* @__PURE__ */ new WeakMap(), _MessageStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _MessageStream_handleError = /* @__PURE__ */ new WeakMap(), _MessageStream_instances = /* @__PURE__ */ new WeakSet(), _MessageStream_getFinalMessage = function _MessageStream_getFinalMessage2() {
    ...
    if (this.ended)
      return;
    __classPrivateFieldSet7(this, _MessageStream_currentMessageSnapshot, void 0);
    ...
    switch (event.type) {
      ...
      case "message_start": {
        __classPrivateFieldSet7(this, _MessageStream_currentMessageSnapshot, messageSnapshot);
        break;
      }
    }
...
var OmcStandardModelId = `${APP_ID_CAMEL}.standard`;

// ../shared/src/common/commit-manager.ts
init_cjs_shims();
...
var ConsoleLogger = class extends BaseLogger {
  log(level, ...args) {
    console.log(
      `${(/* @__PURE__ */ new Date()).toISOString()} ${level.toUpperCase()} | [${this.channel}] ${formatMessage(...args)}]`
    );
  }
};
...
// ../shared/src/common/transport.ts
init_cjs_shims();

// ../shared/src/common/validators.ts
init_cjs_shims();
...
// src/index.ts
var loadPrompt = (lang, diff) => {
  return `\u4F5C\u4E3A\u4E00\u4E2A\u7ECF\u9A8C\u4E30\u5BCC\u7684\u5F00\u53D1\u8005\uFF0C\u8BF7\u5206\u6790\u4EE5\u4E0B\u4EE3\u7801\u53D8\u66F4\u5E76\u751F\u6210\u63D0\u4EA4\u4FE1\u606F\uFF1A
${diff}`;
};
var OmcStandardModel = class {
...
var OmcOfficialProvider = class extends BaseGenerateCommitProvider {
  id = APP_ID_CAMEL;
  ...
  anthropic = null;
  constructor(logger, _apiKey, proxyUrl) {
    super();
    if (logger) {
      this.logger = logger;
    }
    ...
    if (apiKey) this.anthropic = new sdk_default(config);
  }
  generateCommit(input) {
    ...
    return (
      ...
      ResultAsync.fromPromise(
        this.callApi(input),
        (error) => new GenerateCommitError(-10086, `failed to call api, reason: ${formatError(error)}`)
      ).andThen(
        (response) => ResultAsync.fromPromise(
          this.handleApiResult(response),
          (error) => new GenerateCommitError(
            -10087,
  ...
  callApi(input) {
    ...
    return this.anthropic.messages.create({
      ...
      tool_choice: { type: "tool", name: "generate_commit" }
    });
  }
...
var index_default = OmcOfficialProvider;
...
exports.OmcOfficialProvider = OmcOfficialProvider;
